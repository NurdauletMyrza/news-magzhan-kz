...
const NewsDetail: React.FC = () => {
  ...
  function shareURL(network: "facebook" | "twitter" | "vk") {
  ...
  return (
    <div className="news-detail-page">
      <article className="news-detail">
        ...
        <section className="news-detail__social-actions social-actions">
          <button className={`social-actions__like-button social-action ${likes === post?.likes ? "" : "liked-button"}`} onClick={likeButtonHandler}>
          ...
          <div className="social-actions__share-social-net social-action">
            <button className="social-action__button" onClick={() => shareURL("facebook")}>
              <svg className="button__icon facebook-icon" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button className="social-action__button" onClick={() => shareURL("twitter")}>
              <svg className="button__icon twitter-icon" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button className="social-action__button" onClick={() => shareURL("vk")}>
              <svg className="button__icon vk-icon" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
